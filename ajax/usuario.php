...
switch ($_GET["op"]) {
	...
	if (empty($idusuario)) {
		$rspta=$usuario->insertar($nombre,$num_documento,$direccion,$telefono,$email,$login,$clavehash,$imagen);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar todos los datos del usuario";
	}else{
		$rspta=$usuario->editar($idusuario,$nombre,$num_documento,$direccion,$telefono,$email,$login,$clavehash,$imagen);

...
switch ($_GET["op"]) {
	...
	if (empty($idarticulo)) {
		$rspta=$articulo->insertar($codigo,$nombre,$stock,$precio,$descripcion,$imagen);
		echo $rspta ? "Articulo registrados correctamente" : "No se pudo registrar codigo o nombre existente";
	}else{
         $rspta=$articulo->editar($idarticulo,$codigo,$nombre,$stock, $precio,$descripcion,$imagen);
